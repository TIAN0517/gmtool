...
BOOL CPageUser::OnInitDialog()
{
	...
	GetDlgItem(IDC_USER_PAGE_BUTTON_NEW)->EnableWindow(bEnable);
	GetDlgItem(IDC_USER_PAGE_BUTTON_BLOCK)->EnableWindow(bEnable);

	GetDlgItem(IDC_USER_PAGE_BUTTON_UNBLOCK)->EnableWindow(bEnable);
	GetDlgItem(IDC_USER_PAGE_BUTTON_CHATBLOCK)->EnableWindow(bEnable);
	GetDlgItem(IDC_USER_PAGE_BUTTON_CHATUNBLOCK)->EnableWindow(bEnable);
	GetDlgItem(IDC_USER_PAGE_BUTTON_SETLOGOUT)->EnableWindow(bEnable);
	GetDlgItem(IDC_USER_PAGE_BUTTON_CHARACTERS)->EnableWindow(bEnable);
	GetDlgItem(IDC_USER_PAGE_BUTTON_LOGLOGIN)->EnableWindow(bEnable);
