...
BOOL CCharEditPageBasic::DataSave()
{
	...
	StringCchCopy(m_pData->m_szName, CHAR_SZNAME+1, strName.c_str() );
	StringCchCopy(m_pData->m_szNick, CHAR_SZNAME+1, strGUName.c_str() );

	/*activity system, Juver, 2017/11/05 */
	StringCchCopy(m_pData->m_szBadge, CHAR_SZNAME+1, strBadge.c_str() );
