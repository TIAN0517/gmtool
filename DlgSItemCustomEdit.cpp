...
BEGIN_MESSAGE_MAP(CDlgSItemCustomEdit, CDialog)
	...
	ON_BN_CLICKED(IDC_SITEMCUSTOM_EDIT_BUTTON_SOCKET_REMOVE, OnBnClickedSitemcustomEditButtonSocketRemove)
END_MESSAGE_MAP()
...
void CDlgSItemCustomEdit::DataShow()
{
	...
	SetWin_Num_int( this, IDC_SITEMCUSTOM_EDIT_EDIT_SOCKET_COUNT, m_pItemCustom->wGemSlotCount );

	SetWin_Num_int( this, IDC_SITEMCUSTOM_EDIT_EDIT_SOCKET_MID_1, m_pItemCustom->sGemStone_ID[0].wMainID );
	SetWin_Num_int( this, IDC_SITEMCUSTOM_EDIT_EDIT_SOCKET_SID_1, m_pItemCustom->sGemStone_ID[0].wSubID );

	SetWin_Num_int( this, IDC_SITEMCUSTOM_EDIT_EDIT_SOCKET_MID_2, m_pItemCustom->sGemStone_ID[1].wMainID );
	SetWin_Num_int( this, IDC_SITEMCUSTOM_EDIT_EDIT_SOCKET_SID_2, m_pItemCustom->sGemStone_ID[1].wSubID );

	SetWin_Num_int( this, IDC_SITEMCUSTOM_EDIT_EDIT_SOCKET_MID_3, m_pItemCustom->sGemStone_ID[2].wMainID );
	SetWin_Num_int( this, IDC_SITEMCUSTOM_EDIT_EDIT_SOCKET_SID_3, m_pItemCustom->sGemStone_ID[2].wSubID );
}
...
BOOL CDlgSItemCustomEdit::DataSave()
{
	...
	WORD wSocketCount = GetWin_Num_int( this, IDC_SITEMCUSTOM_EDIT_EDIT_SOCKET_COUNT );

	int nSocket_Mid1 = GetWin_Num_int( this, IDC_SITEMCUSTOM_EDIT_EDIT_SOCKET_MID_1 );
	int nSocket_Sid1 = GetWin_Num_int( this, IDC_SITEMCUSTOM_EDIT_EDIT_SOCKET_SID_1 );

	int nSocket_Mid2 = GetWin_Num_int( this, IDC_SITEMCUSTOM_EDIT_EDIT_SOCKET_MID_2 );
	int nSocket_Sid2 = GetWin_Num_int( this, IDC_SITEMCUSTOM_EDIT_EDIT_SOCKET_SID_2 );

	int nSocket_Mid3 = GetWin_Num_int( this, IDC_SITEMCUSTOM_EDIT_EDIT_SOCKET_MID_3 );
	int nSocket_Sid3 = GetWin_Num_int( this, IDC_SITEMCUSTOM_EDIT_EDIT_SOCKET_SID_3 );
	...
	m_pItemCustom->wGemSlotCount = wSocketCount;

	m_pItemCustom->sGemStone_ID[0].wMainID = (WORD)nSocket_Mid1;
	m_pItemCustom->sGemStone_ID[0].wSubID = (WORD)nSocket_Sid1;

	m_pItemCustom->sGemStone_ID[1].wMainID = (WORD)nSocket_Mid2;
	m_pItemCustom->sGemStone_ID[1].wSubID = (WORD)nSocket_Sid2;

	m_pItemCustom->sGemStone_ID[2].wMainID = (WORD)nSocket_Mid3;
	m_pItemCustom->sGemStone_ID[2].wSubID = (WORD)nSocket_Sid3;
...
void CDlgSItemCustomEdit::OnBnClickedSitemcustomEditButtonSocketRemove()
{
	SetWin_Num_int( this, IDC_SITEMCUSTOM_EDIT_EDIT_SOCKET_COUNT, 0);
	SetWin_Num_int( this, IDC_SITEMCUSTOM_EDIT_EDIT_SOCKET_MID_1, NATIVEID_NULL().wMainID );
	SetWin_Num_int( this, IDC_SITEMCUSTOM_EDIT_EDIT_SOCKET_SID_1, NATIVEID_NULL().wSubID );
	SetWin_Num_int( this, IDC_SITEMCUSTOM_EDIT_EDIT_SOCKET_MID_2, NATIVEID_NULL().wMainID );
	SetWin_Num_int( this, IDC_SITEMCUSTOM_EDIT_EDIT_SOCKET_SID_2, NATIVEID_NULL().wSubID );
	SetWin_Num_int( this, IDC_SITEMCUSTOM_EDIT_EDIT_SOCKET_MID_3, NATIVEID_NULL().wMainID );
	SetWin_Num_int( this, IDC_SITEMCUSTOM_EDIT_EDIT_SOCKET_SID_3, NATIVEID_NULL().wSubID );
}
