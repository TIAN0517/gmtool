...
enum EMSHOPITEM2_SEARCH
{
	...
	EMSHOPITEM2_SEARCH_DISCOUNT		= 7,
	EMSHOPITEM2_SEARCH_CURRENCY		= 8,
	EMSHOPITEM2_SEARCH_SIZE			= 9,
};
...
enum EMSHOP_ITEM_CURRENCY_TYPE
{
	SHOPPAGE_ITEMCURRENCY_EPOINTS	= 0,
	SHOPPAGE_ITEMCURRENCY_PPOINTS	= 1,
	SHOPPAGE_ITEMCURRENCY_TYPE		= 2,
};

DWORD	GetCurrencyType( EMSHOP_ITEM_CURRENCY_TYPE emType );

enum EMSHOP_ITEM_CATEGORY_TYPE
{
	SHOPPAGE_ITEMCATEGORY_ALL			= 0,
	SHOPPAGE_ITEMCATEGORY_MALESET		= 1,
	SHOPPAGE_ITEMCATEGORY_FEMALESET		= 2,
	SHOPPAGE_ITEMCATEGORY_ALLSET		= 3,
	SHOPPAGE_ITEMCATEGORY_WEAPON		= 4,
	SHOPPAGE_ITEMCATEGORY_ACCESSORY		= 5,
	SHOPPAGE_ITEMCATEGORY_WING			= 6,
	SHOPPAGE_ITEMCATEGORY_BOX			= 7,
	SHOPPAGE_ITEMCATEGORY_ENHANCEMENT	= 8,
	SHOPPAGE_ITEMCATEGORY_POWERUP		= 9,
	SHOPPAGE_ITEMCATEGORY_PET			= 10,
	SHOPPAGE_ITEMCATEGORY_VEHICLE		= 11,
	SHOPPAGE_ITEMCATEGORY_CARD			= 12,
	SHOPPAGE_ITEMCATEGORY_SIZE			= 13,
};
...
namespace GMTOOL_GLOBAL
{
	...
	extern std::string strItemShopCurrencyType[SHOPPAGE_ITEMCURRENCY_TYPE];
	extern std::string strItemShopCategoryType[SHOPPAGE_ITEMCATEGORY_SIZE];
};
